...
var _PCGRandom = /*#__PURE__*/require("@effect/data/PCGRandom");
/**
 * @since 1.0.0
 */

/** @internal */
const randomHashCache = /*#__PURE__*/(0, _GlobalValue.globalValue)( /*#__PURE__*/Symbol.for("@effect/data/Hash/randomHashCache"), () => new WeakMap());
/** @internal */
const pcgr = /*#__PURE__*/(0, _GlobalValue.globalValue)( /*#__PURE__*/Symbol.for("@effect/data/Hash/pcgr"), () => new _PCGRandom.PCGRandom());
/**
 * @since 1.0.0
 * @category symbols
 */
