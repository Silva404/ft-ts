 ...
 * @category symbol
 */
export const TypeId = /*#__PURE__*/Symbol.for("@effect/data/List");
/**
 ...
 * @since 1.0.0
 */
export const getEquivalence = isEquivalent => Equivalence.mapInput(ReadonlyArray.getEquivalence(isEquivalent), toReadonlyArray);
 ...
 */
export const isList = u => isObject(u) && TypeId in u;
/**
 ...
 * @since 1.0.0
 */
export const append = /*#__PURE__*/dual(2, (self, element) => appendAllNonEmpty(self, of(element)));
/**
