 ...
 */
export const isSortedSet = u => isObject(u) && TypeId in u;
/**
 * @since 1.0.0
 ...
 * @category constructors
 */
export const fromIterable = ord => iterable => fromTree(RBT.fromIterable(ord)(Array.from(iterable).map(k => [k, true])));
/**
 * @since 1.0.0
 * @category constructors
 */
