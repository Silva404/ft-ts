...
export declare namespace Differ {
    ...
    namespace Context {
         ...
         * @category models
         */
        interface Patch<Input, Output> extends Equal {
    ...
    namespace Chunk {
         ...
         * @category models
         */
        interface Patch<Value, Patch> extends Equal {
    ...
    namespace HashMap {
         ...
         * @category models
         */
        interface Patch<Key, Value, Patch> extends Equal {
    ...
    namespace HashSet {
         ...
         * @category models
         */
        interface Patch<Value> extends Equal {
    ...
    namespace Or {
         ...
         * @category models
         */
        interface Patch<Value, Value2, Patch, Patch2> extends Equal {
