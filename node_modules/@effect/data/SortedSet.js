...
const SortedSetProto = {
  ...
  [Hash.symbol]() {
    return Hash.combine(Hash.hash(TypeId))(Hash.hash(this.keyTree));
  },
  [Equal.symbol](that) {
 ...
 */
const isSortedSet = u => (0, _Predicate.isObject)(u) && TypeId in u;
/**
 * @since 1.0.0
 ...
 */
exports.make = make;
const add = /*#__PURE__*/Dual.dual(2, (self, value) => RBT.has(self.keyTree, value) ? self : fromTree(RBT.insert(self.keyTree, value, true)));
/**
 * @since 1.0.0
 */
exports.add = add;
...
const remove = /*#__PURE__*/Dual.dual(2, (self, value) => fromTree(RBT.removeFirst(self.keyTree, value)));
/**
 * @since 1.0.0
 * @category getters
 */
